...
public class GesturePostEvent extends Event
{
    ...
    public static const HAND_ONE_FINGER:String         	 = "HAND_ONE_FINGER1";
    public static const HAND_TWO_FINGERS:String         	 = "HAND_TWO_FINGERS1";
    public static const HAND_THREE_FINGERS:String         	 = "HAND_THREE_FINGERS1";
	//--------------------------------------------------------------------------
	//
	//  Instance Properties
	//
	...
	public function GesturePostEvent(type:String, bubbles:Boolean = true, cancelable:Boolean = false,
	...
	{
		return new GesturePostEvent(type, bubbles, cancelable,
					_percent, _data)
	}
