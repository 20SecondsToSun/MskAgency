package app.model.materials
{
	...
	public class Informer
	{
		...
		public var arr:Array = ["Дороги свободны", "Дороги почти свободны", "Местами затруднения", "Местами затруднения", "Движение плотное", "Движение затруднено", "Серьезные пробки", "Многокилометровые пробки", "Город стоит", "Пешком быстрее",];
