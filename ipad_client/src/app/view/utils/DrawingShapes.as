package app.view.utils
{
	...
	public class DrawingShapes
	{
		 ...
		 */
		public static function drawArc(target:Graphics, x:Number, y:Number, radius:Number, arc:Number, startAngle:Number = 0, yRadius:Number = 0):Point
		{
		...
		public static function drawTriangle(target:Graphics, x:Number, y:Number, triangleHeight:Number = 100):void
		{		
			target.moveTo(triangleHeight / 2, 0);
			target.lineTo(triangleHeight, triangleHeight);
			target.lineTo(0, triangleHeight);
			target.lineTo(triangleHeight / 2, 0);	
		}
